...
А если хочешь поболтать со мной  
— жми на кнопку Juicy Сhat...💬
...
async def cmd_start(m: Message):
    ...
    kb.adjust(1)
    await m.answer_photo[![temp-Imageaj-TSoh.avif](https://i.postimg.cc/15nfSDwL/temp-Imageaj-TSoh.avif)](https://postimg.cc/N5tg79N4)
